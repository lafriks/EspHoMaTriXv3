...
namespace esphome
{
  ...
  public:
    ...
    void dump_config();
#ifdef USE_ESP32
    PROGMEM Color text_color, alarm_color, rindicator_color, lindicator_color, today_color, day_color, calendar_color, calendar_text_color, weekday_color, rainbow_color, clock_color;
...
#ifdef USE_ESP8266
    Color text_color, alarm_color, gauge_color, gauge_bgcolor, rindicator_color, lindicator_color, today_color, day_color, calendar_color, calendar_text_color, weekday_color, rainbow_color, clock_color;
    ...
    void rainbow_date_screen(int lifetime = D_LIFETIME, int screen_time = D_SCREEN_TIME);
